function Slice_ratioANDlimit_SixthTab(FigH,Center,halfThickness,app)


    if strcmpi(app.T6DD1.Value,'x-axis')
    ...
    elseif strcmpi(app.T6DD1.Value,'y-axis')
    ...
    elseif strcmpi(app.T6DD1.Value,'z-axis')
        xlim(FigH,[app.AxisLimits(1,1),app.AxisLimits(1,2)])
        ylim(FigH,[app.AxisLimits(2,1),app.AxisLimits(2,2)])
